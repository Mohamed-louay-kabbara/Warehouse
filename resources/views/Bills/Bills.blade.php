            ...
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <h1 class="modal-title fs-5" id="exampleModalLabel">فاتورة جديدة </h1>
                  ...
                  <form action="{{route('bills.store')}}" method="POST" >
                    @csrf
                      <div class="mb-3">
                        ...
                        <label for="">اسم المورد</label><input type="text" name="Resource_name" class="form-control">
                       <label for=""> السعر</label><input type="text" name="price" class="form-control">
                       <label for="">تاريخ</label> <input type="date" name="created_date" id="" class="form-control">
                      </div>
                  </div>
                    ...
                    <table class="table table-bordered table-hover col-10" id="table_id">
                        <thead>
                            <tr>
                              ...
                              <th scope="col">حذف</th>
                              <th scope="col" data-priority="6">تعديل</th>
                        ...
                        <tbody>
                          ...
                          <td>
                            <button type="button" class="btn btn-outline-danger" data-bs-toggle="modal" data-bs-target="#delete{{ $B->id }}" data-bs-whatever="@mdo">حذف</button>
                    <div class="modal fade" id="delete{{ $B->id }}" tabindex="-1" aria-labelledby="exampleModalLabel2" aria-hidden="true">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <div class="modal-header">
                        ...
                        <form action="{{route('bills.destroy',$B->id)}}"  method="post">
                             ...
                             <td>
                              <button type="button" class="btn btn-outline-success" data-bs-toggle="modal" data-bs-target="#edit{{ $B->id }}" data-bs-whatever="@mdo">تعديل</button>
                              <div class="modal fade" id="edit{{ $B->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                  <div class="modal-content">
                                    <div class="modal-header">
                                      <h1 class="modal-title fs-5" id="exampleModalLabel3">تعديل فاتورة</h1>
                                      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
                                      <form action="{{route('bills.update',$B->id)}}" method="POST">
                                        @method('PUT')
                                        @csrf
                                          <div class="mb-3">
                                            <label for="">عددها</label><input type="text" name="count" class="form-control" value="{{$B->count}}">
                                            <label for="">اسم المورد</label><input type="text" name="Resource_name" class="form-control" value="{{$B->Resource_name}}">
                                           <label for=""> السعر</label><input type="text" name="price" class="form-control" value="{{$B->price}}">
                                           <label for="">تاريخ</label> <input type="date" name="created_date" id="" class="form-control" placeholder="10/1/2000">
                                          </div>
                                      </div>
                                      <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">إغلاق</button>
